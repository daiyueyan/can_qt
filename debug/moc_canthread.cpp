...
QT_MOC_LITERAL(4, 32, 18), // "send_can_info_send"
QT_MOC_LITERAL(5, 51, 4), // "type"
QT_MOC_LITERAL(6, 56, 5), // "index"
QT_MOC_LITERAL(7, 62, 3), // "com"
QT_MOC_LITERAL(8, 66, 9) // "open_flag"

    },
    "CANThread\0getProtocolData\0\0info\0"
    "send_can_info_send\0type\0index\0com\0"
    "open_flag"
};
...
void CANThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getProtocolData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->send_can_info_send((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4]))); break;
        default: ;
        }
        ...
        {
            using _t = void (CANThread::*)(int , int , int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CANThread::send_can_info_send)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CANThread::getProtocolData(QString _t1)
{
...
// SIGNAL 1
void CANThread::send_can_info_send(int _t1, int _t2, int _t3, bool _t4)
{
